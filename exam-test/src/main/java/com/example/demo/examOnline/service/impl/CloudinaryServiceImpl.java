        ...
        try {
            ...
            if (contentType != null) {
                isValidType = contentType
                        .equals("application/vnd.openxmlformats-officedocument.wordprocessingml.document") || // .docx
            ...
            log.info(
                    "Uploading assignment file to Cloudinary - folder: {}, fileName: {}, size: {} bytes, contentType: {}",
